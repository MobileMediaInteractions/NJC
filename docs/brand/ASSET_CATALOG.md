...
| Two Dudes in Wheels provisional mark | `/assets/podcasts/two-dudes-in-wheels/v1/logo-placeholder.png` | Temporary series identity during production; replace with a new immutable version after brand approval |
...
The transparent Two Dudes in Wheels mark was also produced with the built-in
image-generation workflow from an original prompt. It is explicitly a
placeholder and must not be treated as the final approved series identity.
