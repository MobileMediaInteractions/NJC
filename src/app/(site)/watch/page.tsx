  ...
  return (
    <div className="bg-[#041e31] pb-16 text-white">
      <section className="container-news py-10">
        <div className="flex items-center gap-2"><Radio className="size-4 text-brand-red" /><p className="eyebrow text-brand-yellow">Harborline Now</p></div>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.5fr_0.5fr]">
          <div className="relative aspect-video overflow-hidden bg-black">
            <Image src={stories[0].image} alt="Harborline live stream preview" fill priority sizes="75vw" className="object-cover opacity-45" />
