    ...
    <article>
      ...
      <div className="container-news grid max-w-[70rem] gap-10 py-10 lg:grid-cols-[4.25rem_minmax(0,42rem)_1fr]">
        ...
        <div>
          ...
          <section className="mt-10 bg-secondary p-6"><p className="eyebrow text-brand-blue">The Daily Current</p><h2 className="mt-2 text-2xl font-black text-brand-navy">Understand your community before your first coffee.</h2><p className="mb-5 mt-2 text-sm text-muted-foreground">The most useful local stories, every weekday morning.</p><NewsletterForm /></section>
        </div>
