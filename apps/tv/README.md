...
1. Set `EXPO_PUBLIC_TV_API_URL` to the reachable public Harborline origin.
...
The prebuild configures the Leanback launcher, declares that touch input is not required, limits distribution to television devices and installs the Harborline TV banner. Generated `android/` output is intentionally not committed.
