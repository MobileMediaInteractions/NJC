  ...
  return (
    ...
    >
      <Pressable
        ...
        style={featured ? styles.featuredCard : styles.card}
      >
        <Image
        ...
        <View style={styles.content}>
          ...
          <Text style={featured ? styles.featuredHeadline : styles.headline}>
            {story.headline}
          </Text>
          <Text style={styles.dek} numberOfLines={featured ? 3 : 2}>
            {story.dek}
          </Text>
          <View style={styles.meta}>
            <Text style={styles.metaText}>
              {story.location} · {story.readingMinutes} min
            </Text>
            <AppIcon name="chevron-forward" size={15} color={colors.muted} />
          </View>
        </View>
      </Pressable>
    </Link>
...
const makeStyles = (colors: AppColors) =>
  StyleSheet.create({
    ...
    dek: { color: colors.muted, fontSize: 14, lineHeight: 20, marginTop: 8 },
    meta: {
      flexDirection: "row",
      alignItems: "center",
