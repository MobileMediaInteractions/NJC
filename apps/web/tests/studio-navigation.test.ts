...
test("navigation hides unauthorized and unavailable destinations", () => {
  ...
  for (const id of ["tips", "twenty-under-twenty", "team", "notification-campaigns", "link-in-bio", "settings", "legal-registry", "domain-control", "chat", "press-releases", "distribution-manager", "finance-overview", "finance-ledger", "finance-reconciliation", "finance-settings"]) {
