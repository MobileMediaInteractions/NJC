...
export default function SettingsPage() { return <StudioGate><div className="max-w-3xl"><h1 className="text-3xl font-bold tracking-tight">Settings</h1><p className="mt-1 text-sm text-muted-foreground">Configure the network without touching presentation code.</p><Card className="mt-7"><CardHeader><CardTitle>Brand & region</CardTitle><CardDescription>These defaults are centralized in src/lib/site.ts for the fictional launch.</CardDescription></CardHeader><CardContent className="grid gap-5 sm:grid-cols-2"><Field label="Network name" value="Harborline Local" /><Field label="Primary city" value="Port Alder" /><Field label="Region" value="Harbor County" /><Field label="Station ID" value="HLN 8" /><div className="sm:col-span-2"><Button>Save changes</Button></div></CardContent></Card><Card className="mt-6"><CardHeader><CardTitle>Commercial modules</CardTitle><CardDescription>Built in but disabled for launch.</CardDescription></CardHeader><CardContent className="space-y-5"><Toggle label="Advertising placements" /><Toggle label="Membership" /><Toggle label="Donations" /></CardContent></Card></div></StudioGate>; }
