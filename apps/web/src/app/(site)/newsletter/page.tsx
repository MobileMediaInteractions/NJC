...
export default function NewsletterPage() {
  return (
    <div className="container-news py-12">
      <div className="mx-auto max-w-4xl text-center"><p className="eyebrow text-brand-blue">Stay informed</p><h1 className="headline-balance mt-3 text-5xl font-black tracking-[-0.055em] text-brand-navy sm:text-6xl">Local news that meets you where you are.</h1><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">Choose a useful briefing—not another noisy inbox. Every Courier email is written and edited for Middlesex County.</p></div>
      <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
        <NewsletterOption icon={<MailOpen />} title="The Middlesex Morning" schedule="Weekdays · 6:30 a.m." copy="Five essential stories, a sharp weather look and one thing worth knowing." />
