...
async function readDatasets(): Promise<Dataset[]> {
  ...
  const data = await Promise.all([
    ...
    db.select().from(schema.alerts), db.select().from(schema.liveEvents), db.select().from(schema.newsTips), db.select().from(schema.twentyUnderTwentyPrograms), db.select().from(schema.twentyUnderTwentySubmissions), db.select().from(schema.pressKitRequests), db.select().from(schema.pressAssets), db.select().from(schema.pressKitRequestAssets), db.select().from(schema.pressKitMessages), db.select().from(schema.pressKitPackages), db.select().from(schema.pressKitAuditLogs), db.select().from(schema.pressReleases), db.select().from(schema.apiKeys),
  ...
  const definitions = [
    ...
    ["alerts", schema.alerts], ["live_events", schema.liveEvents], ["news_tips", schema.newsTips], ["twenty_under_twenty_programs", schema.twentyUnderTwentyPrograms], ["twenty_under_twenty_submissions", schema.twentyUnderTwentySubmissions], ["press_kit_requests", schema.pressKitRequests], ["press_assets", schema.pressAssets], ["press_kit_request_assets", schema.pressKitRequestAssets], ["press_kit_messages", schema.pressKitMessages], ["press_kit_packages", schema.pressKitPackages], ["press_kit_audit_logs", schema.pressKitAuditLogs], ["press_releases", schema.pressReleases], ["api_keys", schema.apiKeys],
